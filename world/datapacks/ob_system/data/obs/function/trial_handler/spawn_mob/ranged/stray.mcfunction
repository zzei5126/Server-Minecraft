...
summon stray ~ ~ ~ {Tags:["cob.trial_mob","cob.spawned"],ArmorDropChances:[-327.670F,-327.670F,-327.670F,-327.670F],drop_chances:{feet:0.000,legs:0.000,chest:0.000,head:0.000,mainhand:0.000,offhand:0.000},DeathLootTable:"obs:entity/trial_mob"}
